...
/**
 * Class AssetPortletPreferencesHelper.
 * @author bas9004
 *
 */
public class AssetPortletPreferencesHelper {

    public AssetPortletPreferencesHelper(Optional<PortletPreferences> portletPreferencesOptional) {
